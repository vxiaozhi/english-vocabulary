...
with open('json/3-cet4-顺序.json') as f:
    words = json.load(f)

with open('json/3-cet4-indent.json', 'w') as f:
...
with open('json/3-cet4-indent-no-repeat.json', 'w') as f:
    json.dump(words, f, indent=2, ensure_ascii=False)
...
with open('json/3-cet4-indent-capital.json', 'w') as f:
