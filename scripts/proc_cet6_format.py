...
with open('json/4-CET6-顺序.json') as f:
    words = json.load(f)

with open('json/4-CET6-indent.json', 'w') as f:
...
with open('json/4-CET6-indent-no-repeat.json', 'w') as f:
    json.dump(words, f, indent=2, ensure_ascii=False)
...
print([word['word'] for word in words_capital])
