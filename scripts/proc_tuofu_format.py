...
with open('json/6-托福-顺序.json') as f:
    words = json.load(f)

with open('json/6-tuofu-indent.json', 'w') as f:
...
with open('json/6-tuofu-indent-no-repeat.json', 'w') as f:
    json.dump(words, f, indent=2, ensure_ascii=False)
...
with open('json/6-tuofu-indent-capital.json', 'w') as f:
